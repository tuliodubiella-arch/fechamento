...
function renderAuth() {
  ...
  $("#app").innerHTML = `<div class="auth-screen"><div class="auth-box"><div class="brand"><img class="brand-logo" src="brand/logo-principal.png" alt="Grupo Cavalca"><strong>Fechamento contábil</strong></div>
